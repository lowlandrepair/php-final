...
switch ($action) {
    ...
    case 'create_incident':
        ...
        if ($title === '' || $type === '' || $severity < 1 || $severity > 5) {
        ...
        try {
            ...
            $id = $pdo->lastInsertId();
            echo json_encode(['success' => true, 'incident_id' => $id, 'message' => 'Incident reported successfully!']);
    ...
    case 'resolve_incident':
        ...
        try {
            ...
            $stmt2 = $pdo->prepare($sql2);
            $stmt2->execute([':incident_id' => $incidentId]);
